...
class dropbox_client:
    def __init__(self,access_token:Dict,md:bool,change_refresh_token:bool):
    
        try:
            try:
                creds = self._get_tokens(access_token,change_refresh_token)
    ...
    def _get_tokens(self,access_token,change_refresh_token):
